...
namespace SysEscuela {
    ...
    public partial class DataSetAlumnos : global::System.Data.DataSet {
        ...
        public partial class AlumnoDataTable : global::System.Data.TypedTableBase<AlumnoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AlumnoRow AddAlumnoRow(string Nombre, string Apellido, int Edad, int Telefono, string Direccion, string Email, string Observaciones) {
...
namespace SysEscuela.DataSetAlumnosTableAdapters {
    ...
    public partial class AlumnoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Alumno] ([Nombre], [Apellido], [Edad], [Telefono], [Direccion], [Email], [Observaciones]) VALUES (@Nombre, @Apellido, @Edad, @Telefono, @Direccion, @Email, @Observaciones);
SELECT id, Nombre, Apellido, Edad, Telefono, Direccion, Email, Observaciones FROM Alumno WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Alumno] SET [Nombre] = @Nombre, [Apellido] = @Apellido, [Edad] = @Edad, [Telefono] = @Telefono, [Direccion] = @Direccion, [Email] = @Email, [Observaciones] = @Observaciones WHERE (([id] = @Original_id) AND ([Nombre] = @Original_Nombre) AND ([Apellido] = @Original_Apellido) AND ([Edad] = @Original_Edad) AND ((@IsNull_Telefono = 1 AND [Telefono] IS NULL) OR ([Telefono] = @Original_Telefono)) AND ((@IsNull_Direccion = 1 AND [Direccion] IS NULL) OR ([Direccion] = @Original_Direccion)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Observaciones = 1 AND [Observaciones] IS NULL) OR ([Observaciones] = @Original_Observaciones)));
SELECT id, Nombre, Apellido, Edad, Telefono, Direccion, Email, Observaciones FROM Alumno WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=DESKTOP-N10B9GL;Initial Catalog=EscuelaDB;Integrated Security=True";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Nombre, Apellido, Edad, Telefono, Direccion, Email, Observaciones FROM" +
                " dbo.Alumno";
        ...
        public virtual int Delete(int Original_id, string Original_Nombre, string Original_Apellido, int Original_Edad, global::System.Nullable<int> Original_Telefono, string Original_Direccion, string Original_Email, string Original_Observaciones) {
        ...
        public virtual int Insert(string Nombre, string Apellido, int Edad, global::System.Nullable<int> Telefono, string Direccion, string Email, string Observaciones) {
            if ((Nombre == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Apellido, int Edad, global::System.Nullable<int> Telefono, string Direccion, string Email, string Observaciones, int Original_id, string Original_Nombre, string Original_Apellido, int Original_Edad, global::System.Nullable<int> Original_Telefono, string Original_Direccion, string Original_Email, string Original_Observaciones) {
            return this.Update(Nombre, Apellido, Edad, Telefono, Direccion, Email, Observaciones, Original_id, Original_Nombre, Original_Apellido, Original_Edad, Original_Telefono, Original_Direccion, Original_Email, Original_Observaciones, Original_id);
        }
    }
